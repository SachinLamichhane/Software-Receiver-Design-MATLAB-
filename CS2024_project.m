...
str = input('Enter Signal A, B or C:','s');
...
%% Upsampling
fs = 2 * f_s;               % increasing sampling frequency by m times
...
figure("Name","Preprocessed Signal"), plotspec(rp,Ts)    % plot frequency response
...
figure('Name',"Constellation diagram after OPM"), subplot(2,1,1), plot(r_tim,'b.')        
...
mu=.03; delta=5;             % stepsize and delay delta
